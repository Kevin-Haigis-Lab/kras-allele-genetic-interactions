# Figure 014. Labeled high-level view of comutation network for MM.
...
panel_B_1 <- read_fig_proto("mm_comut_heatmap") +
    theme_fig14() +
    theme(
        legend.position = "bottom",
        axis.title = element_blank()
    )
panel_B_2 <- read_fig_proto("allele_freq_barplot") +
    theme_fig14() +
    theme(
    ...
    labs(tag = "b")
panel_B_3 <- read_fig_proto("gene_freq_barplot") +
    theme_fig14() +
    theme(
