...
all_panels <- read_fig_proto("ggrdige-stats_all-plots") %>%
...

{
  ...
  mm_panels <- wrap_plots(all_panels[9:10], design = mm_design)
  paad_panels <- wrap_plots(all_panels[11:15], design = paad_design)
