# Supplemental Figure 8. Labeled high-level view of comutation network for LUAD
...
#### ---- A. Labeled LUAD reduced not G12C-only comutation graph ---- ####
# The reduced comutation graph for LUAD except for interaction with G12C-only
