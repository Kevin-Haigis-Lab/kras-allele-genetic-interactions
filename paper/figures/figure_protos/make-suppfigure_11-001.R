...
figS11_patch_ggsurvplot <- function(ggsurv_obj, layout_heights = c(9, 3, 1)) {
...
figS11_modify_survplot_components <- function(p, leg_regex, pal,
                                              legend_nrow = 1,
                                              tag = NULL) {
    p$plot <- p$plot +
        scale_color_manual(
