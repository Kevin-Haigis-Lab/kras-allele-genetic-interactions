...
ggsave_wrapper(allele_prob_ranking_barplot,
...
ggsave_wrapper(most_likely_other_allele,
...
ggsave_wrapper(prob_of_other_alleles,
...
ggsave_wrapper(distribution_of_allele_probs,
