...
LUAD_GRAPH_ANNOTATIONS <- list(
  # G12C
  "WNT signaling" = c(
    "WNT11", "WNT9A", "LRP6", "WNT2", "CTNNB1",
    "NOTCH1", "FRAT2", "PTPRJ", "TCF7L1", "PYGO1",
    "CDH10", "JAG2"
  ),
  "ECM" = c(
    "COL5A2", "COL6A6", "COL28A1", "COL24A1", "COL14A1",
    "COL11A1", "COL3A1", "COL8A2", "FN1", "FLNA", "LAMC1",
    "VCAN", "ITGA4"
  ),
  "cell cycle\nregulation" = c(
    "MDC1", "MRE11A", "FANCM", "RAD54B",
    "EXO1", "SMC4", "NCAPD2", "STAG2", "CENPE",
    "SUN1", "AHCTF1"
  ),
  "regulation of ERK1/2" = c("EPHB6", "EPHA5", "EPHA6", "EPHA8", "EPHA2"),
  "chromatin\nremodeling" = c(
    "ARID1B", "ARID1A", "HCFC1", "SRCAP",
    "ASXL1"
  ),
  "L1CAM interactions" = c("SCN5A", "SCN10A", "NRCAM", "NFASC", "CNTN1"),
  "glycosylation" = c(
    "ADAMTS16", "ADAMTS8", "ADAMTS15", "THSD7B", "ACAN",
    "HAPLN1"
  ),
  # G12V
  "vasoconstriction" = c(
    "EDN1", "KALRN", "ADRA1D", "EDNRA", "ADCY2",
    "EDN1"
  ),
  "transcriptional\nregulation" = c(
    "POLR2A", "HNRNPUL1", "WWP2", "CREB1",
...
special_nodes <- c(
  "KRAS", "BRAF", "NRAS", "PIK3CA", "APC", "TP53",
